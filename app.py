...
selected_comp1 = st.sidebar.selectbox("Select Component 1 (Light Key)", component_options)
# Remove selected_comp1 from options for comp2
component_options_comp2 = [comp for comp in component_options if comp != selected_comp1]
selected_comp2 = st.sidebar.selectbox("Select Component 2 (Heavy Key)", component_options_comp2)

# Get properties based on selection
comp1 = selected_comp1
comp2 = selected_comp2
...
st.sidebar.write(f"Boiling point of {comp1}: {bp1}°C")
st.sidebar.write(f"Molecular weight of {comp1}: {mw1} g/mol")
st.sidebar.write(f"Boiling point of {comp2}: {bp2}°C")
st.sidebar.write(f"Molecular weight of {comp2}: {mw2} g/mol")
...
if st.button("Run Simulation"):
    # Add a check to ensure xd > feed_comp > xb
